	...
	class nggLoader {
		...
		function load_scripts() {
			...
			if ( ( $this->options['thumbEffect'] == 'shutter' ) && ! function_exists( 'srel_makeshutter' ) ) {
				wp_register_script( 'shutter', NGGALLERY_URLPATH . 'public/js/shutter-reloaded.min.js', false, '1.3.3' );
				wp_localize_script(
					'shutter',
					'shutterSettings',
					array(
		...
		function load_styles() {
			...
			if ( $nxc ) {
				wp_enqueue_style( 'qunit', NGGALLERY_URLPATH . 'public/css/qunit-1.16.0.css', false, '1.0.0', 'screen' );
			}
