	...
	public function load_scripts() {
		...
		switch ( $_GET['page'] ) {
			...
			case "nggallery-manage":
				...
				wp_register_script( 'shutter', NGGALLERY_URLPATH . 'public/js/shutter-reloaded.js', false, '1.3.2' );
	...
	public function load_styles() {
		...
		switch ( $_GET['page'] ) {
			...
			case "nggallery-options" :
				...
				break;
			case "nggallery-manage":
				wp_enqueue_style( 'ngg-cropper', NGGALLERY_URLPATH . 'public/css/cropper.min.css', '2.2.5' );
				wp_enqueue_style( 'shutter', NGGALLERY_URLPATH . 'public/css/shutter-reloaded.css', false, '1.3.2',
					'screen' );
